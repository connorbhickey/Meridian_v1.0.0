...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "cvxpy.utilities",
        "cvxpy.cvxcore",
        "portopt.engine.prediction",
        "portopt.engine.prediction.ensemble",
        "portopt.engine.prediction.monte_carlo",
        "portopt.engine.prediction.data_provider",
        "portopt.engine.prediction.prng",
        "portopt.engine.prediction.signals",
    ],
    hookspath=[str(ROOT / "scripts" / "hooks")],
    hooksconfig={},
    runtime_hooks=[str(ROOT / "scripts" / "hooks" / "runtime_hook_cvxpy.py")],
    excludes=[
        "tkinter",
